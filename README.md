...
- 📊 **High-Performance Real-time Analytics Dashboard**: Features a graphical admin dashboard (`/admin`) tracking **Today's New Activations** and **Intercepted Attack Volumes** in real-time. Supports generating thousands of keys in a single second and exporting fully formatted CSV reports.
